...
const ExternalLoginConfirmation = (props: any) => {
  return (
    <Layout title="ExternalLoginConfirmation">
      <h2>ViewBag.Title.</h2>
      ...
      <p className="text-info">
        ...
        <strong>@ViewBag.LoginProvider</strong>. Please enter a user name for
        this site below and click the Register button to finish logging in.
      </p>
