...
using AutomationTestSite.ViewModels;
...
namespace AutomationTestSite.Controllers
{
    public class DepartmentsController : Controller
    {
        ...
        public ActionResult Details(int? id)
        {
            ...
            DepartmentViewModel dvmc = new DepartmentViewModel();
            dvmc.Departments = db.Departments.Find(id);
            dvmc.Employees = db.Employees.Where(p => p.DepartmentID == id).ToList();
            if (dvmc.Departments == null)
            {
                return HttpNotFound();
            }
            return View(dvmc);
